...
# Crea un certificado autofirmado para HTTPS en Spring Boot, con SAN para localhost y 127.0.0.1
...
Write-Host "Keystore creado: $KeystorePath" -ForegroundColor Green
